...
if __name__ == '__main__':
    ...
    device = 'cuda:0'
    net = InceptionResnetV1(num_classes=8631, device=device)
    net.load_state_dict(torch.load('facenet.pth'))
    net.eval()

    dump_x = torch.randn(2, 3, 112, 112).to(torch.device('cuda:0'))
    ...
    for i in range(1000):
        ...
        print(start_time.elapsed_time(end_time))
        # running_frame_rate = 1 * float(1 / (end_time - start_time))
